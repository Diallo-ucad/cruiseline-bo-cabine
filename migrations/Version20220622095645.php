 ...
 */
final class Version20220622095645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_price ADD timestamp DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_price DROP timestamp, CHANGE fare_type_code fare_type_code VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE fare_type_desc fare_type_desc VARCHAR(200) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE lang lang VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
